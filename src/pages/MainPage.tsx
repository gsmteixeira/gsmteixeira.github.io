      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="flex flex-col-reverse gap-10 md:flex-row md:items-center">
            ...
            <div className="md:w-1/2 space-y-5">
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                I am a PhD candidate in astrophysics working at the intersection
                of observational cosmology and machine learning. My research
                focuses on extracting physical insight from large astronomical
                surveys using deep learning methods, from photometric redshift
                estimation to the study of transient phenomena and dark siren
          ...
          <div className="grid gap-10 md:grid-cols-[minmax(0,2fr)_minmax(0,1.4fr)] items-start">
            <div>
              ...
              <p className="text-sm md:text-base text-slate-700 leading-relaxed mb-4">
                I am currently pursuing my PhD in astrophysics at the Brazilian
                Center for Research in Physics (CBPF), where I work with large
                photometric surveys and the application of artificial
                intelligence to astronomical data. My main interests lie in
                transient astrophysics, cosmology, and the use of deep and
                probabilistic neural networks to extract robust information from
                noisy, high–dimensional observations.
              </p>
              <p className="text-sm md:text-base text-slate-700 leading-relaxed">
                Beyond my research, I enjoy collaborating with multidisciplinary
                teams, contributing to international survey projects, and
                sharing knowledge through seminars, schools, and courses on
        ...
        <section id="pesquisa" className="py-16 md:py-20">
          <div className="mb-8">
            ...
            <p className="text-sm md:text-base text-slate-700 max-w-2xl">
              My research explores how deep learning can help us understand the
              dynamic and evolving Universe, with a focus on transients,
            ...
            >
              ...
              <article className="group rounded-2xl bg-white/90 border border-[#d7dde5] p-5 shadow-sm shadow-slate-200/70 hover:shadow-md hover:-translate-y-1 transition">
                ...
                <p className="text-sm text-slate-700 leading-relaxed">
                  ...
                  transients, such as supernovae, using time–domain surveys and
                  follow–up observations. I build tools to identify transient
                  candidates, study their light curves and spectra, and connect
                  them to the physical processes behind stellar explosions.
                </p>
              </article>
            </Link>
        ...
        <section id="palestras" className="py-16 md:py-20">
          <div className="mb-6">
            ...
            <p className="text-sm md:text-base text-slate-700 max-w-2xl">
              ...
              both the astrophysics and the data–science aspects of my research.
            </p>
          </div>
        ...
        <section id="projetos" className="py-16 md:py-20">
          <div className="mb-6">
            ...
            <p className="text-sm md:text-base text-slate-700 max-w-2xl">
              I collaborate with survey and analysis teams working on wide–field
              optical imaging, transient searches, and cosmological probes.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-white/90 border border-[#d7dde5] p-4 shadow-sm">
              ...
              <p className="text-xs md:text-sm text-slate-600">
                Application of deep and probabilistic models to galaxy surveys,
                enabling improved constraints on cosmology and structure
                formation.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-2 items-start">
            <div>
              ...
              <p className="text-sm md:text-base text-slate-700 mb-4">
                If you are interested in collaborations, seminar invitations, or
                would like to know more about my work, feel free to reach out. I
                am always open to discussing new ideas at the interface of
                astrophysics, cosmology, and machine learning.
              </p>
